...
// IDirect3D8 vtable layout (indices 0–16):
...
namespace
{
    ...
    inline constexpr auto k_d3d8_create_device_idx = 16u;
...
IDirect3D8* WINAPI hk_direct3d_create8(UINT sdk_version)
{
    ...
    if ((d3d != nullptr) && (g_d3d8_vtable == nullptr))
    {
        ...
        constexpr auto entry_count = 32u; // IDirect3D8 has 17 entries; 32 is safe

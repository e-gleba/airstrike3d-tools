...
using glu_look_at_fn = void(APIENTRY*)(GLdouble, GLdouble, GLdouble, GLdouble, GLdouble, GLdouble,
...
void APIENTRY hk_gl_load_identity() {
    ...
    if (g_ctx.current_matrix_mode == GL_MODELVIEW) {
        sdk::detail::invoke_on_gl_identity();
    }
}

void APIENTRY hk_glu_look_at(GLdouble ex, GLdouble ey, GLdouble ez, GLdouble cx, GLdouble cy,
                              GLdouble cz, GLdouble ux, GLdouble uy, GLdouble uz) {
    auto consumed{sdk::detail::invoke_on_glu_lookat(ex, ey, ez, cx, cy, cz, ux, uy, uz)};

    if (!consumed) {
        call_if_hooked<glu_look_at_fn>(g_ctx.hooks.glu_look_at, ex, ey, ez, cx, cy, cz, ux, uy,
                                       uz);
    }
}

...
void text_colored(float r, float g, float b, float a, const std::string& t) noexcept;

// Buttons
[[nodiscard]] bool button(const std::string& label) noexcept;
[[nodiscard]] bool button_sized(const std::string& label, float w, float h) noexcept;

// Input widgets
[[nodiscard]] bool checkbox(const std::string& label, bool& v) noexcept;
[[nodiscard]] bool drag_float(const std::string& label, float& v, float spd, float mn, float mx) noexcept;
[[nodiscard]] bool slider_float(const std::string& label, float& v, float mn, float mx) noexcept;
[[nodiscard]] bool slider_int(const std::string& label, int& v, int mn, int mx) noexcept;
[[nodiscard]] bool input_text(const std::string& label, std::string& text) noexcept;
[[nodiscard]] bool color_edit3(const std::string& label, float& r, float& g, float& b) noexcept;
...
[[nodiscard]] bool collapsing_header(const std::string& label, bool open) noexcept;

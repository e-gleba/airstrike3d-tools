...
public:
    ...
    [[nodiscard]] float get_music_volume() const override { return music_volume_; }
    [[nodiscard]] bool is_music_playing() const override;
    [[nodiscard]] bool is_music_paused() const override;
    [[nodiscard]] music_handle current_music() const override { return current_music_; }
    ...
    [[nodiscard]] float get_sound_volume() const override { return sound_volume_; }
